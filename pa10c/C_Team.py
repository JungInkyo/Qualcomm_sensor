...
if __name__ == '__main__':
    ...
    while True:
        ...
        temp = round(sensor_output.get('Temp', -1), 2)
        SN1 = round(sensor_output.get('SN1', -1), 2)
        SN2 = round(sensor_output.get('SN2', -1), 2)
        SN3 = round(sensor_output.get('SN3', -1), 2)
        SN4 = round(sensor_output.get('SN4', -1), 2)
        PM25 = round(sensor_output.get('PM25', -1), 2)
